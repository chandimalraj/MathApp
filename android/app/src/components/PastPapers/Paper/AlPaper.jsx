...
const AlPaper = ({navigation}) => {

    const route = useRoute();
    const {syllabus,subject,year} = route.params
 
   
    const subjects = ["Pure Mathematics" , "Applied Mathematics" ]
    ...
    <View style={styles.container}>
          ...
          <ScrollView
            ...
            {subjects.map(section => (
              ...
              onPress={()=>{
                navigation.navigate('PaperView',{subjectPart:section , subject:subject , year:year , syllabus:syllabus})
              }}
              >
                <Image
